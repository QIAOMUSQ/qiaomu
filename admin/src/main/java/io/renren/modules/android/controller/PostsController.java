...
import io.renren.modules.android.base.BaseController;
...
import io.renren.modules.android.entity.User;
...
public class PostsController extends BaseController {
    ...
    public QuarkResult CreatePosts(Posts posts, String token, Integer labelId) {
        QuarkResult result = restProcessor(() -> {
            ...
            SysUserEntity userbytoken = userService.getUserByToken(token);
            if (userbytoken == null) return QuarkResult.warn("用户不存在,请先登录！");


            postsService.savePosts(posts, labelId, userbytoken);
