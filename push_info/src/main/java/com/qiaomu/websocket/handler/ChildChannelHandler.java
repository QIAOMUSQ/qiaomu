...
public class ChildChannelHandler extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel socketChannel) throws Exception {
        ...
        pipeline.addLast("http-chunked",new ChunkedWriteHandler());// ChunkedWriteHandler：向客户端发送HTML5文件
        pipeline.addLast("handler",new InfoWebSocketServerHandler());// 在管道中添加我们自己的接收数据实现方法
    }
}
